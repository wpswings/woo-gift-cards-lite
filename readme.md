...
2) The WooCommerce gift card plugin is compatible with the [**WooCommerce Subscriptions Pro**](https://makewebbetter.com/product/woocommerce-subscriptions-pro/?utm_source=MWB-giftcard-git&utm_medium=MWB-git-page&utm_campaign=MWB-giftcard-git) plugin that enables you to leverage the following benefits:
...
* [**Ultimate WooCommerce Gift Cards Documentation**](https://docs.makewebbetter.com/giftware-woocommerce-gift-cards/?utm_source=MWB-giftcard-git&utm_medium=MWB-git-page&utm_campaign=MWB-giftcard-git)
