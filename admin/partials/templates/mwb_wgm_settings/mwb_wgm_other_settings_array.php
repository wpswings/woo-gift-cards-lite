...
$settings_obj = new Woocommerce_Giftcard_Admin_settings();
 $mwb_wgm_other_setting = array(
	array(
	  ...
	  'type' => 'checkbox',
	  'class' => 'input-text',
	  'desc_tip' =>  __('Check this if you want to disable Apply Coupon Fields if there only GifCard Products are in Cart/Checkout Page',MWB_WGM_DOMAIN),
	  'desc' =>  __('Disable Apply Coupon Fields on Cart/Checkout page',MWB_WGM_DOMAIN)
	),
	array(
	  ...
	  'desc' =>  __('Disable Preview Button At Front End',MWB_WGM_DOMAIN)
	)
	);
