        ...
        <table class="form-table wps_wgm_general_setting">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            href="<?php echo WPS_WGC_URL ; ?> admin/uploads/wps_wgm_custom_gift_sample.csv">Export
        ...
        <table class="form-table wps_wgm_general_setting">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            href="<?php echo WPS_WGC_URL ; ?>/admin/uploads/wps_wgm_giftproduct_sample.csv">Export
                            Demo CSV <span class="wps_sample_export_org"><img
                                    src="<?php echo WPS_WGC_URL ; ?>/assets/images/download.png"></span>
                        </a>
                    </td>
