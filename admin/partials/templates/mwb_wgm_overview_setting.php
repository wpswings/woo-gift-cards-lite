...
<div class="mwb_wgm_table_wrapper mwb_wgm_overview-wrapper">
	<div class="mwb_wgm_overview_content">
		<h3 class="mwb_wgm_overview_heading"><?php esc_html_e( 'Connect With Us and Explore More About Ultimate Gift Cards For WooCommerce', 'woocommerce_gift_cards_lite' ); ?></h3>
