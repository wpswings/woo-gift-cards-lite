						...
						<tr valign="top">
							...
							<td class="forminp forminp-text">
								...
								<label for="wcgw_plugin_enable">
									...
									if ( isset( $offine_giftcard_redeem_link ['shop_url'] ) && $offine_giftcard_redeem_link['shop_url'] !== '' ) {
										echo esc_url( $offine_giftcard_redeem_link['shop_url'] );  }
									?>
										">
							...
							<tr valign="top">
								...
								<td class="forminp forminp-text">
									...
									echo wp_kses_post( wc_help_tip( $attribut_description ) );
									?>
									<textarea cols="20" rows="3" id="mwb_wgm_embeded_input_text">
										<?php
										if ( isset( $offine_giftcard_redeem_link ['embed_url'] ) && $offine_giftcard_redeem_link['embed_url'] !== '' ) {
											echo esc_url( $offine_giftcard_redeem_link['embed_url'] );  }
										?>
										</textarea>
										<div class="mwb-giftware-copy-icon">									
											<button  class="mwb_embeded_copy mwb_redeem_copy" data-clipboard-target="#mwb_wgm_embeded_input_text" title="copy">
												<i class="far fa-copy" ></i>
											</button>
										</div>
									</td>
