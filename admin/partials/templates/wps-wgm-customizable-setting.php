    ...
    <div class="wps_wgm_table_wrapper">
        <div class="wps_table">
            <div style="display: none;" class="loading-style-bg" id="wps_uwgc_loader">
                <img src="<?php echo WPS_WGC_URL ; ?> assets/images/loading.gif">
            </div>
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <span class="woocommerce-help-tip"></span> <label for="wps_wgm_customizable_enable">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <span class="woocommerce-help-tip"></span> <label for="wps_wgm_upload_enable">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <span class="woocommerce-help-tip"></span> <label for="wps_wgm_default_and_upload_enable">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <span class="woocommerce-help-tip"></span> <input type="button" name=""
