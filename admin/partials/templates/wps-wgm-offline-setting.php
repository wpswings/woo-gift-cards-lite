        ...
        <table class="form-table wps_wgm_general_setting">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a
                            href="<?php echo WPS_WGC_URL ; ?>admin/uploads/wps_wgm_offline_coupon_import.csv">Export
                            Demo CSV <span class="wps_sample_export_org"><img
                                    src="<?php echo WPS_WGC_URL ; ?>assets/images/download.png"></span>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <table class="wps_gift-ware__offline widefat">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="<?php echo WPS_WGC_URL ; ?>admin/uploads/wps_wgm_gift_card_sample.csv">Export
                                        Demo CSV <span class="wps_sample_export_org"><img
                                                src="<?php echo WPS_WGC_URL ; ?>assets/images/download.png"></span>
