...
class Woocommerce_Giftcard_Admin_settings {
	...
	public function mwb_wgm_generate_checkbox_html( $value, $general_settings ) {
		...
		<label for="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>">
			<input type="checkbox" name="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>" <?php checked( $enable_mwb_wgm, 1 ); ?> id="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>" class="<?php echo esc_attr( array_key_exists( 'class', $value ) ? $value['class'] : '' ); ?>"> <?php echo esc_attr( array_key_exists( 'desc', $value ) ? $value['desc'] : '' ); ?>
		</label>
		<?php
	}
	...
	public function mwb_wgm_generate_radiobuttons_html( $value, $general_settings ) {
		...
		?>
		<label for="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>">
			<input value = "<?php echo esc_attr( array_key_exists( 'value', $value ) ? $value['value'] : '' ); ?>" type="radio" name="<?php echo esc_attr( array_key_exists( 'name', $value ) ? $value['name'] : '' ); ?>" <?php checked( $enable_mwb_wgm, 1 ); ?> id="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>" class="<?php echo esc_attr( array_key_exists( 'class', $value ) ? $value['class'] : '' ); ?>"> <?php echo esc_attr( array_key_exists( 'desc', $value ) ? $value['desc'] : '' ); ?>
		</label>
		<?php
	}
	...
	public function mwb_wgm_generate_number_html( $value, $general_settings ) {
		...
		<label for="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>">
			...
			?>
			 value="<?php echo esc_attr( $mwb_wgm_value ); ?>" name="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>" id="<?php echo esc_attr( array_key_exists( 'id', $value ) ? $value['id'] : '' ); ?>"
	...
	public function mwb_wgm_generate_tool_tip( $value ) {
		if ( array_key_exists( 'desc_tip', $value ) ) {
			$description = esc_html__( $value['desc_tip'], 'woocommerce_gift_cards_lite' );
	...
	public function mwb_wgm_generate_textarea_html( $value, $general_settings ) {
		...
		<label for="mwb_wgm_general_text_points" class="mwb_wgm_label">
			<textarea 
			<?php
			if ( array_key_exists( 'custom_attribute', $value ) ) {
			...
			class="<?php echo esc_attr( array_key_exists( 'class', $value ) ? $value['class'] : '' ); ?>"><?php echo esc_attr( array_key_exists( 'desc', $value ) ? $value['desc'] : '' ); ?><?php echo esc_attr( $mwb_wgm_value ); ?>
		</textarea>
	</label>
			...
			if ( isset( $setting_html_array['top'] ) && is_array( $setting_html_array['top'] ) ) {
				foreach ( $setting_html_array['top'] as $top_section_setting ) {
					if ( isset( $top_section_setting['id'] ) && array_key_exists( $top_section_setting['id'], $posted_data ) ) {
						...
						if ( isset( $top_section_setting['type'] ) && $top_section_setting['type'] === 'wp_editor' ) {
			...
			if ( isset( $setting_html_array['middle'] ) && is_array( $setting_html_array['middle'] ) ) {
				foreach ( $setting_html_array['middle'] as $mid_section_setting ) {
					if ( isset( $mid_section_setting['id'] ) && array_key_exists( $mid_section_setting['id'], $posted_data ) ) {
						...
						if ( isset( $mid_section_setting['type'] ) && $mid_section_setting['type'] === 'wp_editor' ) {
			...
			if ( isset( $setting_html_array['bottom'] ) && is_array( $setting_html_array['bottom'] ) ) {
				foreach ( $setting_html_array['bottom'] as $bottom_section_setting ) {
					if ( isset( $bottom_section_setting['id'] ) && array_key_exists( $bottom_section_setting['id'], $posted_data ) ) {
						...
						if ( isset( $bottom_section_setting['type'] ) && $bottom_section_setting['type'] === 'wp_editor' ) {
