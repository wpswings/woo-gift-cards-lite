			...
			<div class="mwb_wgm_header_content_right">
				<ul>
					...
					if ( mwb_uwgc_pro_active() ) {
						?>
						<li><a href="?page=mwb-wgc-setting-lite&tab=redeem_tab" class="mwb_wgm_redeem_link"><span><?php esc_html_e( 'New', 'woo-gift-cards-lite' ); ?></span><?php esc_html_e( 'Giftcard Redeem Feature', 'woo-gift-cards-lite' ); ?></a></li>
						...
						<li class="mwb_wgm_header_menu_button">
							<a  href="https://makewebbetter.com/product/giftware-woocommerce-gift-cards/?utm_source=mwb-giftcard-org&utm_medium=mwb-org&utm_campaign=giftcard-org" class="" title="" target="_blank"><?php esc_html_e( 'GO PRO NOW', 'woo-gift-cards-lite' ); ?></a>
						</li>
						<li>
							<a id="mwb-wgm-skype-link" href="<?php echo esc_url( 'https://join.skype.com/invite/IKVeNkLHebpC' ); ?>" target="_blank">
								<img src="<?php echo esc_url( MWB_WGC_URL . 'assets/images/skype_logo.png' ); ?>" style="height: 15px;width: 15px;" ><?php esc_html_e( 'CHAT NOW', 'woo-gift-cards-lite' ); ?>
							</a>
						</li>	
						<?php
					}
